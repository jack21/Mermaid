...
type
  TFormBill = class(TForm)
    ...
    DiscountQRLabel2: TQRLabel;
    DiscountQRDBText2: TQRDBText;
    QRShape4: TQRShape;
    QRLabel36: TQRLabel;
...
begin
  ...
  begin
    ...
    DiscountQRLabel2.Caption := '';
    DiscountQRDBText2.DataField := '';
  end
  else
  begin
    DiscountQRLabel.Caption := '折讓';
    DiscountQRDBText.DataField := 'Discount';
    DiscountQRLabel2.Caption := '折讓';
    DiscountQRDBText2.DataField := 'Discount';
  end;
...
//    BillReport.PrinterSettings.PrinterIndex := 0;
    BillReport2.PrinterSettings.FirstPage := 0;
    BillReport2.PrinterSettings.LastPage := 0;
//    BillReport.Prepare;
    BillReport2.Print;
  end;
end;
